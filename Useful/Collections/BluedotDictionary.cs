...
namespace IHI.Server.Useful
{
    ...
    public class BluedotDictionary<TKey, TValue> : IDictionary<TKey, TValue> where TValue : class
    {
        ...
        public class LazyLoadingBehaviour
        {
            ...
            internal Func<TKey, TValue> ValueFactory
            {
                get;
                private set;
            }

            internal LazyLoadingBehaviour(bool lazyKeys, bool lazyValues, Func<TKey, TValue> lazyValueFactory)
            {
                Keys = lazyKeys;
                Values = lazyValues;
        ...
        public class DirtyTrackingBehaviour
        {
            ...
            internal DirtyTrackingBehaviour(bool dirtyValueTracking)
            {
        ...
        public class ReadOnlyBehaviour
        {
            ...
            internal ReadOnlyBehaviour(bool readonlyValues, bool readonlyKeys)
            {
        ...
        public class WeakReferenceBehaviour
        {
            ...
            internal WeakReferenceBehaviour(bool weakValues)
            {
                Values = weakValues;
            }
        }
