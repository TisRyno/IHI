...
namespace IHI.Server.Useful
{
    ...
    internal class BiDirectionalDictionary<TFirst, TSecond>
    {
        ...
        internal void RemoveByFirst(TFirst first)
        {
            TSecond second;
            if (!_firstToSecond.TryGetValue(first, out second))
                throw new ArgumentException("first");
        ...
        internal void RemoveBySecond(TSecond second)
        {
            TFirst first;
            if (!_secondToFirst.TryGetValue(second, out first))
                throw new ArgumentException("second");
        ...
        internal Boolean TryAdd(TFirst first, TSecond second)
        {
            if (_firstToSecond.ContainsKey(first) || _secondToFirst.ContainsKey(second))
                return false;
        ...
        internal Boolean TryGetByFirst(TFirst first, out TSecond second)
        {
        ...
        internal Boolean TryGetBySecond(TSecond second, out TFirst first)
        {
        ...
        internal Boolean TryRemoveByFirst(TFirst first)
        {
            TSecond second;
            if (!_firstToSecond.TryGetValue(first, out second))
                return false;
        ...
        internal Boolean TryRemoveBySecond(TSecond second)
        {
            TFirst first;
            if (!_secondToFirst.TryGetValue(second, out first))
                return false;
