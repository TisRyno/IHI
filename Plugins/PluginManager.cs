...
namespace IHI.Server.Plugins
{
    public class PluginManager
    {
        ...
        internal Plugin LoadPluginAtPath(string path)
        {
            ...
            {
                CoreManager.ServerCore.ConsoleManager.Notice("Plugin Manager", CoreManager.ServerCore.StringLocale.GetString("CORE:ERROR_PLUGIN_NOT_EXIST", path));
                return null;
            }
            ...
            {
                CoreManager.ServerCore.ConsoleManager.Warning("Plugin Manager", CoreManager.ServerCore.StringLocale.GetString("CORE:ERROR_PLUGIN_NOT_EXIST", Path.GetFileNameWithoutExtension(path)));
                CoreManager.ServerCore.ConsoleManager.Debug("Plugin Manager", path);
                return null;
            }
